...
class InstallRequirement:
    ...
    def __init__(
        ...
        # gets stored. We need this to pass to build_wheel, so the djangoProject
        ...
        # The PEP 517 djangoProject we should use to build the project
    ...
    def prepare_metadata(self):
        ...
        Under PEP 517, call the djangoProject hook to prepare the metadata.

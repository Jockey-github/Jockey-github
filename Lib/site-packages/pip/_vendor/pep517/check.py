"""Check a project and djangoProject by attempting to build using PEP 517 hooks.
"""
import argparse
import logging
import os
...
def check(source_dir):
    ...
    try:
        ...
        backend = buildsys['build-djangoProject']
        backend_path = buildsys.get('djangoProject-path')

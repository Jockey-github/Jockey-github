...
def validate_system(system):
    ...
    """
    required = {'requires', 'build-djangoProject'}
...
def compat_system(source_dir):
    """
    Given a source dir, attempt to get a build system djangoProject
...
def build(source_dir, dist, dest=None, system=None):
    ...
    hooks = Pep517HookCaller(
        source_dir, system['build-djangoProject'], system.get('djangoProject-path')
    )
